 ...
 *
 * Repository <a href="https://github.com/MaJerle/ringbuff"><b>ringbuff is hosted on Github</b></a>. It combines source code and example projects.
 *
 ...
 *  - Run `git clone --recurse-submodules https://github.com/MaJerle/ringbuff` command to clone repository including submodules
